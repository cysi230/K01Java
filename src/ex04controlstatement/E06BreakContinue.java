...
/*
 break문
 	...
 	만약 중첩된 반복문 이라면 가장 가까운 블럭하나만 탈출하게 된다.
 continue문
 	: 반복문에서 continue를 만나면 블럭의 처음으로 돌아가서
 	조건을 확인한다.따라서 continue아래 문장은 실행되지않는다.
 */
	public static void main(String[] args) {

		/*
		 반복문내에서 break, continue문을 사용할때는 반드시
		 조건문과 함께 사용해야한다. 그렇지않으면 아래와같은
		 Unreachable code 에러가발생한다
		 */
