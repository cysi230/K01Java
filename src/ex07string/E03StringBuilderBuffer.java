...
/*
 ...
 생성하면 원래 문자열은 변하지않고 새롭게 생성된 메모리에 
 문자열을 저장한다 .기존메모리가 소멸되고 새로운 메모리가 생성되는
 낭비를 막기위해 StringBuffer 클래스가 사용된다
 해당클래스는 새로운 메모리를 생성하지않고 기존메모리의 문자열을 변경한다
 */
...
public class E03StringBuilderBuffer {
	...
	public static void main(String[] args) {
		...
		System.out.println("String과 StringBuffer의"+"참조값비교");
		String str1 = "코스모";
		String str2 = "코스모";
		if(str1==str2)
		...
		System.out.println("기존버프크기"+ buf.capacity());
