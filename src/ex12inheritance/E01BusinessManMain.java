...
// [[[[부모클래스]]](상위 , 기본, super): 사람의 일반적인 형태를추상화함
class Man{
	private String name;
...
class BusinessMan extends Man{//확장
	private String company;
	private String position;
	
	/*
	 상속받은 자식클래스에 부모클래스의  생성자를 호출하여 부모객체가
	 먼저생성되도록 해야하는 책임을 가지고있다.
	 super()는 부모클래스의 생성자를 호출한는 역할을 하게되며
	...
	public void tellYourInfo() {
		...
		//부모클래스에 정의된 멤버메소드 호출, 상속받았으므로 즉시 호출가능함
		tellYourName();	//호출가능
	}	
}
