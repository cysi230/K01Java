...
public class E04StringType {
	...
	public static void main(String[] args) {
		...
		System.out.println(strNumber + number);//[100+99]10099
		
		/*
		String은 클래스이므로 new 키워드를 이용해서 인스턴스(객체)를 생성한 후 문자열을 참조한다
		 */
		String newString = new String("new 키워드만 사용");
		System.out.println(newString);
		
		String stringBasic = "클래스지만";
		String plusString = "기본자료형처럼사용";
		System.out.println(stringBasic +" "+ plusString);
		
		/*
		문자열+숫자=> 우선순의가 없다면 일반적으로 문자열로 표현한다.
