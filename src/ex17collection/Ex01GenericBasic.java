...
//오렌지 전용 박스: Orange 객체만 저장 할수 있는 클래스
class OrangeBox{
	Orange item;
...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 OrangeBox에 Orange객체를 생성한후 저장하고 정보출력함
		 */
		...
		/*
		 상자1은 오렌지 전용박스이므로 다른 과일(즉객체)를 저장할수 없다
		...
		/*
		Object기반으로 한 FruitBox구현에는 편리하나 코드레벨에서
		컴파일에러가 발생하지 않으므로, 오류를 찾아내기가 훨씬 힘들다
