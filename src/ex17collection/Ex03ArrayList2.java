...
//		LinkedList<Student> list2 = new LinkedList<Student>();
		...
		list2.add(st3);
		list2.add(st4);//인덱스3
		list2.add(st2);/*객체의 중복저장, List컬렉션은 허용돰*/
		...
		//인덱스를 통한 삭제: 삭제성공 해당객체가 반환된다
		System.out.println("삭제된 객체의 이름: "+ list2.remove(2).name);
		//인스턴스 참고값을 통한 삭제 : 삭제성공시 boolean값이 반환된다.
