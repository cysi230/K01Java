...
public class E06Random {
	...
	public static void main(String[] args) {
		...
		/*
		 컴푸터는 인자로 전달되는 seed(씨앗)기반 난수를 생성한다
		 만약 seed값이 동일하다면 항상 동일 패턴의 난수를 생성하게 되는데
		...
		//현재 시간을 밀리 초단위로 반환하는 메소드
		System.out.println(System.currentTimeMillis());
		//random클래스틑 통해 난수생성을 할때 seed를 설정하기 위한 메소드
		...
		for (int i = 0; i < 10; i++) {			
			/*
			 ...
			 난수가 생성된다 또한 범위가 없기때문에 몇자리가 생성될지 알수없다.
			 */
