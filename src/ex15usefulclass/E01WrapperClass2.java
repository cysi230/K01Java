...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		 1]parseInt(): 숫자형식의 문자열을 숫자로 변경헌다
		 	주로 웹에서 많이 사용한다
		 */
		String strNumber = "1000";
		System.out.println("10+strNumber"+(10+strNumber));//101000
		System.out.println("10+strNumber 숫자로변경"+(10+Integer.parseInt(strNumber)));//1010
		System.out.println("10+strNumber 숫자로변경"+(10+Integer.valueOf(strNumber)));//동일한 기능
...
//		System.out.println(Integer.parseInt(floatString));//예외발생
		...
		/*
		 3] isDigit: 인자로 전달된 문자가 숫자인지판단
		 숫자일때 true 반환
		 */
		System.out.println("isDigit()를 통한 숫자판당");
		...
		/*
		 6] 대소문자를 판단하는 메소드
		 : 영문자에만 적용되고 알파벳이 아닌경우 모저건 false를 반환한다.
		 */
		System.out.println("알파벳 대소문자판단");
		...
		/*
		시나리오] 주어진 문자열안에 몇개의 공백문자(스페이스)가있는지 판단하는 프로그램을 작성하시오
		참고) toCharArray(): 문자열을 char형배열로 반환해주는 String 클래스에 정의된 메소드
		 */
