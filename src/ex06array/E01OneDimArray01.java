...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		/*
		 ...
		 주소값을 반환한다, 그래서(배열변수)는 주소값(참조값)을
		...
		/*
		 배열의 선언 및 초기화: 배열은 여러개의 변수를 사용하기위해 선언하므로
		 			   	   접근을 위해 일반적으로 반복문을 사용한다
		 배열명.length: 해당배열의 크기를 반환한다. 배열의
		 			   크기가 변경되는 경우이에 유연하게 사용할수있다
		 */
		int[] arrNumber= new int[40];//데이터 40개가 저장되는공간 만듬 
		for(int i=0 ; i<arrNumber.length ; i++) {//lenght(길이,크기) [배열의크기] 반환 0~39
			arrNumber[i] = i+10;
		}
		for(int i=0 ; i <40 ; i++) {
		...
		/*
		 ...
		 new키워드는 생략한다
		 */
		System.out.println("방법3: 초기값으로 선언");
